...
REM
REM Generated by Vivado on Thu Jun 11 09:15:34 +0530 2026
...
echo "xvlog --incr --relax -prj STA_Timing_tb_vlog.prj"
call xvlog  --incr --relax -prj STA_Timing_tb_vlog.prj -log xvlog.log
